((global)=>{
 ...
 class NotesStore{
  ...
  validate(value){if(!value.title.trim()||value.title.length>120)throw Error('请填写标题，最多 120 个字');if(!value.body.trim()||value.body.length>50000)throw Error('请填写正文，最多 50000 个字');if(!['生活片段','阅读随想','灵感手记'].includes(value.category))throw Error('请选择有效分类')}
